...
export default function Footer() {
  return (
    <footer className="bg-navy text-cream mt-24">
      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-8 py-14 grid gap-10 sm:grid-cols-3">
        <div>
          <Image
            ...
            width={64}
            height={64}
            className="rounded-full border border-cream/20 object-cover object-top h-16 w-16 mb-4"
          />
          <Image
            src="/images/lance-the-realtor-logo.png"
            alt="Lance the Realtor"
            width={120}
            height={155}
          ...
          <div className="mt-5 bg-cream rounded-lg inline-block p-2">
            <Image
              src="/images/jmg-logo.png"
              alt="Jason Mitchell Group"
              width={140}
              height={101}
      ...
      <div className="border-t border-cream/10 py-10 text-center">
        <p className="text-xs uppercase tracking-[0.2em] text-camel font-semibold mb-3">
          Call or Text Lance
        </p>
        <a
          href="tel:+18018605225"
          className="font-display text-4xl sm:text-5xl italic text-terracotta hover:text-camel transition-colors"
        >
          (801) 860-5225
        </a>
      </div>
